class LocalizacionResponse {
  ...
  late final List<Localizacion> results;
  
  LocalizacionResponse.fromJson(Map<String, dynamic> json){
    info = Info.fromJson(json['info']);
    results = List.from(json['results']).map((e)=>Localizacion.fromJson(e)).toList();
  }
...
class Localizacion {
  ...
  Localizacion.fromJson(Map<String, dynamic> json){
    id = json['id'];
    name = json['name'];
    type = json['type'];
